package com.example.chuong4.ui.bbsk;
...
import com.example.test.databinding.FragmentBbskBinding;

public class BbskFragment extends Fragment {
    private FragmentBbskBinding binding;
    private BbskViewModel bbskViewModel;

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        // Initialize ViewModel
        bbskViewModel = new ViewModelProvider(this).get(BbskViewModel.class);
